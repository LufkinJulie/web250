...
* Demomstrate how to create a database, create table and insert records
*/

$mysqli = new mysqli('localhost', 'root', 'veryscecret');
...
(`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`,
...
{
    echo "<p>Error inserting Honda Pilot:</p>".$mysqli->error."<br>";
    echo "<p>***********</p>";
    echo $query;
    echo "<p>***********</p>";
}
...
(`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`,
 `TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`) 
VALUES
('LAKSDFJ234LASKRF2', '2002', 'Dodge', 'Durango', 'SLT', 'Silver', 'Black', '2700', NULL, '2000', '144000', '4WD Automatic', '2012-12-05', NULL);";

if ($mysqli->query($query)===TRUE){
    echo "<p>Dodeg Durango inserted into inventory table.</p>";
}
else
{
    echo "<p>Error inserting Dodeg Durango:</p>".$mysqli->error."<br>";
    echo "<p>***********</p>";
    echo $query;
    echo "<p>***********</p>";
}
...
$query3 = "INSERT INTO `Cars`.`inventory` (`VIN`, `YEAR`, `Make`, `Model`, `TRIM`, `EXT_COLOR`, `INT_COLOR`, `ASKING_PRICE`, `SALE_PRICE`, `PURCHASE_PRICE`, `MILEAGE`, 
`TRANSMISSION`, `PURCHASE_DATE`, `SALE_DATE`)
 VALUES
