...
else
{
    ...
    echo "VIN: " .$vin."<br>";
    echo "Stored temportarily as: ".$_FILES["file"]["tmp_name"]."<br><BR>"."\n";
    ...
    $imagename="uploads/".basename($_FILES['files']['name']);
    echo "The full file name of the uploaded file is ".$target_path."<br>"."\n";

    echo "The relative name of the fiile for use in the IMG tage is ". $imagename."<br><br>"."\n";
